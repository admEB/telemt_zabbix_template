...
* **Детализированный LLD пользователей**: Автоматическое обнаружение пользователей позволяет вести точечный мониторинг. Шаблон отслеживает не только базовую активность, но и контролирует утилизацию лимитов — рассчитывает процент используемых IP-адресов и TCP-соединений от максимально разрешенных для каждого конкретного пользователя.
